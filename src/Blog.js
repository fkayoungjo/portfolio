    ...
    return (
      <div id="blog">
          <Container className = "divs">
            ...
            <Col xs="6" sm="4"><blockquote class="embedly-card"><h4><a href="https://medium.com/@jordan.simon55/what-is-a-framework-fb567413482c" target="_blank">What is a Framework?</a></h4><p>Before we can learn about what a framework is we must understand what a programming language is. A programming language is essentially how we communicate with computers and tell them what to do through the use of syntax and semantics. A framework is a collection of programs brought together to accomplish a task, improving efficiency when creating new software.</p></blockquote>
            <script async src="//cdn.embedly.com/widgets/platform.js" charset="UTF-8"></script> </Col>
            <Col sm="4"><blockquote class="embedly-card"><h4><a href="https://medium.com/@jordan.simon55/binding-pry-and-how-it-helped-me-learn-ruby-69a02c3862fa" target="_blank">Binding.pry and how it helped me learn RUBY</a></h4><p>When learning to code, everyone catches on at different rates. Everyone's mind processes this new information at their own speed. Learning to code is learning how to speak to computers. It's learning a language that you have never been exposed to. When I decided to learn to code, I knew it would be a daunting task.</p></blockquote>
            <script async src="//cdn.embedly.com/widgets/platform.js" charset="UTF-8"></script> </Col>
            </Row>
          </Container>
      </div>
